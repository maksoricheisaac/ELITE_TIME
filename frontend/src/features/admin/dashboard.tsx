...
export default function AdminDashboardClient({ stats }: AdminDashboardClientProps) {
  const { totalUsers, employees, departments } = stats;
    ...
    <div className="space-y-6 py-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">Vue d&apos;ensemble de l&apos;entreprise</p>
        </div>
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-4 h-1 rounded-full bg-muted overflow-hidden">
                  <div
                    ...
                    style={{ width: `${Math.min(100, (card.value / Math.max(totalUsers, 1)) * 100)}%` }}
                  />
                </div>
              </CardContent>
            </Card>
